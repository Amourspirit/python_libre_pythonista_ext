...
def test_new_doc(loader, build_setup) -> None:
    ...
    if TYPE_CHECKING:
        ...
        from oxt.pythonpath.libre_pythonista_lib.query.calc.doc.qry_is_doc_pythonista import QryIsDocPythonista
    else:
        from libre_pythonista_lib.query.qry_handler import QryHandler
        from libre_pythonista_lib.query.calc.doc.qry_is_doc_pythonista import QryIsDocPythonista
