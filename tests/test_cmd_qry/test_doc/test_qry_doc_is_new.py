...
def test_is_new_doc(loader, build_setup) -> None:
    ...
    if TYPE_CHECKING:
        ...
        from oxt.pythonpath.libre_pythonista_lib.cq.qry.calc.doc.qry_is_doc_new import QryIsDocNew
    else:
        from libre_pythonista_lib.cq.qry.qry_handler import QryHandler
        from libre_pythonista_lib.cq.qry.calc.doc.qry_is_doc_new import QryIsDocNew
