...
def test_cmd_pyc_rule(loader, build_setup) -> None:
    if TYPE_CHECKING:
        ...
        from oxt.pythonpath.libre_pythonista_lib.cmd.calc.sheet.cell.prop.cmd_pyc_rule_del import CmdPycRuleDel
    else:
        ...
        from libre_pythonista_lib.cmd.calc.sheet.cell.prop.cmd_pyc_rule_del import CmdPycRuleDel
