...
def test_cmd_array_ability(loader, build_setup) -> None:
    ...
    if TYPE_CHECKING:
        from oxt.pythonpath.libre_pythonista_lib.cmd.calc.sheet.cell.prop.cmd_array_ability import CmdArrayAbility
        ...
        from libre_pythonista_lib.cmd.calc.sheet.cell.prop.cmd_array_ability import CmdArrayAbility
