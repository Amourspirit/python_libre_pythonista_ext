...
def test_form_design_mode(loader, build_setup, mocker: MockerFixture) -> None:
    if TYPE_CHECKING:
        from oxt.pythonpath.libre_pythonista_lib.query.calc.doc.qry_form_design_mode import QryFormDesignMode
        from oxt.pythonpath.libre_pythonista_lib.query.qry_handler import QryHandler
    else:
        from libre_pythonista_lib.query.calc.doc.qry_form_design_mode import QryFormDesignMode
