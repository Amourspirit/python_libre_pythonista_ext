...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.cq.cmd.calc.sheet.cell.ctl.cmd_ctl_shape_name_img import (
        CmdCtlShapeNameImg,
    )
    ...
    from libre_pythonista_lib.cq.cmd.calc.sheet.cell.ctl.cmd_ctl_shape_name_img import CmdCtlShapeNameImg
...
class CtlBuilderMatPlotFig(CtlBuilder):
    ...
    def append_commands(self) -> None:
        ...
        self.append(CmdCtlShapeNameImg(cell=self.cell, ctl=self.ctl))
        self.append(CmdMatPlotFigureImg(cell=self.cell, ctl=self.ctl, opt=self._get_control_options()))
