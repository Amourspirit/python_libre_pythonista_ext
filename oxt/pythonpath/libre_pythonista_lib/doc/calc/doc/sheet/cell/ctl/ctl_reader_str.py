...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.query.calc.sheet.cell.ctl.qry_ctl_modify_trigger_event import (
    ...
    from libre_pythonista_lib.query.calc.sheet.cell.ctl.qry_ctl_modify_trigger_event import QryCtlModifyTriggerEvent
