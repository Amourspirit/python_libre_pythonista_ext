...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.cq.qry.calc.sheet.cell.ctl.read.qry_data_tbl import QryDataTbl
    ...
    from libre_pythonista_lib.cq.qry.calc.sheet.cell.ctl.read.qry_data_tbl import QryDataTbl
    from libre_pythonista_lib.utils.custom_ext import override

# tested in: tests/test_doc/test_calc/test_doc/test_sheet/test_cell/test_ctl/test_ctl_builder_str.py


class CtlReaderDataTbl(CtlReaderShapeBase):
    @override
    def append_query(self) -> None:
        super().append_query()
        self.append(QryDataTbl(self.cell, self.ctl))
