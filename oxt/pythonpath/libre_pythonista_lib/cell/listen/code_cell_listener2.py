...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.query.calc.sheet.uno_cell.qry_cell_sheet_doc import QryCellSheetDoc
    ...
    from oxt.pythonpath.libre_pythonista_lib.query.calc.sheet.uno_cell.qry_cell_sheet_name import QryCellSheetName
else:
    from ___lo_pip___.basic_config import BasicConfig as Config
    from libre_pythonista_lib.query.qry_handler import QryHandler
    from libre_pythonista_lib.query.calc.sheet.uno_cell.qry_cell_sheet_doc import QryCellSheetDoc
    ...
    from libre_pythonista_lib.query.calc.sheet.uno_cell.qry_cell_sheet_name import QryCellSheetName
