...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.cq.qry.calc.doc.qry_cell_cache import QryCellCache
    ...
    from libre_pythonista_lib.cq.qry.calc.doc.qry_cell_cache import QryCellCache
...
class CmdInitDoc(CmdBase, List[CmdT], LogMixin, CmdDocT):
    ...
    def _init_queries(self) -> None:
        ...
        qry_cell_cache = QryCellCache(doc=self._doc)
        ...
        self._execute_qry(qry_cell_cache)
