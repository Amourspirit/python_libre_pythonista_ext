...
class CmdModeStatesInit(CmdBase, LogMixin, CmdDocT):
    """Sets a flag that the document Module States has been initialized."""
    ...
    def execute(self) -> None:
        ...
        if doc_globals is None:
            ...
            return
        doc_globals.mem_cache[DOC_MOD_STATES_INIT] = "1"
