...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.cq.query.general.qry_is_import_available import QryIsImportAvailable
    ...
    from libre_pythonista_lib.cq.query.general.qry_is_import_available import QryIsImportAvailable
