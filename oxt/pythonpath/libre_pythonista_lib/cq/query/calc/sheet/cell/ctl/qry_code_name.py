...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.cq.query.calc.sheet.cell.prop.qry_code_name import (
    ...
    from libre_pythonista_lib.cq.query.calc.sheet.cell.prop.qry_code_name import QryCodeName as QryPropCodeName
