...
if TYPE_CHECKING:
    ...
    from oxt.pythonpath.libre_pythonista_lib.cq.qry.config.qry_control_name import QryControlName as QryCfgControlName
    ...
    from libre_pythonista_lib.cq.qry.config.qry_control_name import QryControlName as QryCfgControlName
    from libre_pythonista_lib.cq.qry.calc.sheet.cell.prop.qry_code_name import QryCodeName as QryPropCodeName
    from libre_pythonista_lib.utils.result import Result


class QryControlName(QryBase, QryCellT[Union[Result[str, None], Result[None, Exception]]]):
    ...
    def _qry_control_name(self, code_name: str) -> str:
        """Gets the control name such as ``libre_pythonista_ctl_cell_id_S4JaB6LmJGR2HU``"""
        qry = QryCfgControlName(code_name=code_name)
