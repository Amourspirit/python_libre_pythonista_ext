...
DISPATCH_CELL_CTl_UPDATE = f"{UNO_CS_PROTOCOL}{PATH_CELL_CTl_UPDATE}"
PATH_DF_CARD = "libre_pythonista.calc.cell.df_card"
DISPATCH_DF_CARD = f"{UNO_CS_PROTOCOL}{PATH_DF_CARD}"

PATH_DATA_TBL_CARD = "libre_pythonista.calc.cell.data_tbl_card"
DISPATCH_DATA_TBL_CARD = f"{UNO_CS_PROTOCOL}{PATH_DATA_TBL_CARD}"
