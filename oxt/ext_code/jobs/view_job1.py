...
if TYPE_CHECKING:
    ...
    from ...pythonpath.libre_pythonista_lib.const.event_const import DOCUMENT_NEW_VIEW
    ...
    if _CONDITIONS_MET:
        ...
        from libre_pythonista_lib.const.event_const import DOCUMENT_NEW_VIEW
# endregion imports
                ...
                if _CONDITIONS_MET:
                    try:
                        ...
                        try:
                            ...
                            self._log.error("Error getting CalcStateMgr", exc_info=True)
                        ...
                        eargs.event_data = DotDict(
                            run_id=run_id, doc=doc, event=DOCUMENT_NEW_VIEW, doc_type=doc.DOC_TYPE
                        )
